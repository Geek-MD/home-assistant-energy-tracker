...
- **Device Attributes**: Additional device information (last update time, meter type, meter number, location) stored as sensor attributes
- **Device Class Detection**: Automatic assignment of appropriate device class (energy, gas, water) based on meter type

### Changed
- Extended API wrapper to support fetching devices from Energy Tracker
